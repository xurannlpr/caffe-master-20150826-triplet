...
class TripletLossLayer : public LossLayer<Dtype> {
 public:
  explicit TripletLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_AP() {};
  //explicit TripletLossLayer(const LayerParameter& param)
   // : LossLayer<Dtype>(param), diff_AN() {};
  //explicit TripletLossLayer(const LayerParameter& param)
   // : LossLayer<Dtype>(param), diff_NP() {};
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
 ...
 protected:
  ...
  Blob<Dtype> diff_AP;  // cached for backward pass
  Blob<Dtype> diff_AN;
  Blob<Dtype> diff_NP;
  Blob<Dtype> dist_sq_AP;  // cached for backward pass
  Blob<Dtype> dist_sq_AN;
  Blob<Dtype> dist_sq_NP;
  Blob<Dtype> diff_sq_AP;  // tmp storage for gpu forward pass
  Blob<Dtype> diff_sq_AN;
  Blob<Dtype> diff_sq_NP;
  Blob<Dtype> summer_vec_AP;  // tmp storage for gpu forward pass
  Blob<Dtype> summer_vec_AN;  // tmp storage for gpu forward pass
  Blob<Dtype> summer_vec_NP;  // tmp storage for gpu forward pass
};
